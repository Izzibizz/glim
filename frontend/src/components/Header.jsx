...
export const Header = ({ data }) => {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 w-full z-20 bg-strong-red border-b-2 border-main-red border-opacity-35 backdrop-blur-xl h-24">
          ...
          <div className="flex laptop:gap-10">
            ...
            {loggedIn ? (
              ...
              >
                ...
                >
                  <img src="/products.svg" alt="products" className="h-9 w-9 mt-2 mr-2" />
                </NavLink>
              </div>
            )}
            <NavLink
          ...
          <div className="flex flex-row justify-end tablet:gap-4 laptop:gap-10">
            ...
            {!openBurger && (
              <>
                ...
                >
                  <img src="/products.svg" className="h-7 w-7 mt-2 mr-1" alt="products"/>
                </NavLink>
              </>
            )}
